"""Ghép hai file .xlsx ở mức gói OOXML, giữ nguyên format của report WFX.

openpyxl đọc-ghi lại sẽ làm mất border và khung mà SSRS xuất ra, nên phải trộn
thẳng sheet, styles và defined names trong gói zip. Style index của workbook
nguồn KHÔNG mang nguyên sang được — phải ánh xạ lại theo thuộc tính."""
