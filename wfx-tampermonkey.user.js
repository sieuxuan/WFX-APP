...
// - Đổi hotkey mặc định Ctrl+Alt+X → Ctrl+Shift+X (DEFAULT_HOTKEY cho Tampermonkey + nhãn UI).
...
// - Fix mojibake tiếng Việt trong bản build: build-extension.ps1 đọc userscript bằng Get-Content -Raw
...
(function () {
  ...
  function handleKeydown(event) {
    ...
    // top frame sẽ bị double-toggle (mở rồi đóng ngay). Tampermonkey không có command API nên vẫn
    ...
    shadow.innerHTML = `
      ...
      <aside class="panel" aria-hidden="true" aria-label="WFX Smart Automation">
        ...
        <footer class="panel-footer">
          ...
          <span class="footer-meta">Tampermonkey active · v${SCRIPT_VERSION}</span>
        </footer>
