...
def test_public_version_is_1_1_0():
    assert APP_VERSION == "1.1.0"
    assert DISPLAY_VERSION == "1.1.0"
    assert RELEASE_TAG == "v1.1.0"
...
def test_windows_build_embeds_release_version():
    ...
    assert "ProductVersion', '1.1.0" in info
    assert "prodvers=(1, 1, 0, 0)" in info
