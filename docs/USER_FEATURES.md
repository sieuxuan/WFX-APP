...
Dùng để làm gì Mở Supplier Master theo một Category hoặc tìm tên nhà cung cấp trên tất cả Category. Các bước Mở module Supplier List. Chọn Category nếu bạn biết nhóm của Supplier, rồi bấm Mở Master . Hoặc nhập tên/một phần tên công ty rồi bấm Tìm tất cả Category nếu muốn tìm rộng hơn. Đọc tổng kết kết quả trên bảng điều khiển. Bạn không cần bấm Supplier List trước. Cả đổi Category lẫn tìm đều tự mở danh sách khi WFX chưa mở. Nút Supplier List chỉ là lối tắt khi bạn muốn xem danh sách hiện tại. Mẹo Mẹo Khi tìm tất cả Category, ứng dụng tiếp tục với nhóm kế tiếp nếu một nhóm gặp lỗi và báo rõ kết quả chỉ hoàn thành một phần. Gặp lỗi thì sao Hiện tượng Cách xử lý Master chưa sẵn sàng Chờ danh sách Supplier tải xong rồi bấm Mở Master lại. Chỉ có kết quả một phần Đọc Category bị lỗi trong thông báo, mở riêng Category đó rồi tìm lại. Không thấy Supplier Nhập phần tên ngắn hơn hoặc kiểm tra cách viết tên công ty.
