...
| `SALE_ASN_CREATE_STEPS_REQUIRED` | Chưa chọn bước Sale ASN cần thực hiện | Tích ít nhất một bước: Thêm PO, Order Details, Style Details hoặc Shipping Info. |
